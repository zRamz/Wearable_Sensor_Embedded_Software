...
MOBLEUINT8 UnprovisionInProgress = 1;
...
MOBLE_RESULT Appli_BleSetUUIDCb(MOBLEUINT8 *uuid_prefix_data)
{
  ...
  */
  ...
  uint8_t uuid_buff[10] = {0x32, 0x10,0x4F,0xAE,0x7D,0xEC};/*random value by user */
...
void First_Unprovision(void)
{

    /* Unprovision, show that unprovisioning is completed     */
